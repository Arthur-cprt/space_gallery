...
class LoginForms(forms.Form):
    ...
    senha = forms.CharField(label='Senha', required=True, max_length=50, 
...
class CadastroForms(forms.Form):
    ...
    senha_1 = forms.CharField(label='Senha', required=True, max_length=50, 
                            widget=forms.PasswordInput(attrs={ "class":"form-control", "placeholder":"Digite sua senha" }))
    
    senha_2 = forms.CharField(label='Confirmação de Senha', required=True, max_length=50, 
                            widget=forms.PasswordInput(attrs={ "class":"form-control", "placeholder":"Digite sua senha novamento" }))
